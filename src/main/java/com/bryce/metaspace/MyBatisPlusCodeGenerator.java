...
public class MyBatisPlusCodeGenerator {
    ...
    public static void main(String[] args) {
        // 加载配置
        ConfigurableApplicationContext context = SpringApplication.run(MetaspaceApplication.class, args);
        ...
        dsc.setDriverName(environment.getProperty("spring.datasource.driverClassName"));
        ...
        pc.setEntity("bean");
        pc.setMapper("mapper");
        pc.setModuleName("metaspace");
        pc.setParent("com.bryce");
